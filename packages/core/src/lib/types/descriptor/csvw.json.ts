  ...
  '@graph': {
    ...
    rdfs_properties: [
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:ForeignKey', 'csvw:TableReference'],
        },
        'rdfs:range': 'xsd:string',
      },
      {
      ...
      },
      {
        ...
        'rdfs:range': {
          'owl:unionOf': ['csvw:Datatype', 'xsd:string'],
        },
      },
      {
        '@id': 'csvw:decimalChar',
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:TableGroup', 'csvw:Table'],
        },
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:Table', 'csvw:Schema'],
        },
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:Schema', 'csvw:Row'],
        },
        'rdfs:range': 'xsd:string',
      },
      {
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:Table', 'csvw:Column'],
        },
        'rdfs:range': 'xsd:boolean',
      },
      {
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:Transformation', 'csvw:Column', 'csvw:Row'],
        },
      },
      {
        '@id': 'csvw:trim',
      ...
      },
      {
        ...
        'rdfs:domain': {
          'owl:unionOf': ['csvw:Table', 'csvw:Transformation'],
        },
        'rdfs:range': 'xsd:anyURI',
      },
      {
